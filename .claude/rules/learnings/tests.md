...
**Correction 2026-09-18:** the lead sentence above said a declared command refuses `--no-rerun`
too. It does not, and has not since v3.0.2 — `--no-rerun` and `--from-junit` both set `will_run`
