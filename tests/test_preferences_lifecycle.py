...
# Load prawduct-init.py via importlib (hyphenated filename)
_init_spec = importlib.util.spec_from_file_location(
    "prawduct_init", REPO_ROOT / "tools" / "prawduct-init.py"
)
_init_mod = importlib.util.module_from_spec(_init_spec)
_init_spec.loader.exec_module(_init_mod)
run_init = _init_mod.run_init

# Load prawduct-sync.py
_sync_spec = importlib.util.spec_from_file_location(
    "prawduct_sync", SYNC_SCRIPT_PATH
)
...
class TestLegacyProduct:
    ...
    def test_missing_sync_script_no_crash(self, tmp_path: Path):
        ...
        # Delete sync script from framework
