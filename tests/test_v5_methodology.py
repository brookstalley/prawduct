...
class TestCriticSkill:
    ...
    def test_token_budget(self):
        ...
        # that terse pointer needs ~50 tokens, so the ceiling rises to 3450 --
        # still UNDER the diet's own post-diet +10% formula (~3533), so the diet
        # stays locked. Posture unchanged: prefer trim over bump; relocate
