...
Principles are not checklists. They teach intent. Claude applies them with judgment, adapting to context. The [learnings file](../.prawduct/learnings.md) provides worked examples of how principles apply in practice — the case law that interprets the constitution. The [agent stance](../methodology/agent-stance.md) translates several of these principles into *how the agent communicates and acts* day to day — the working voice that puts the constitution into practice.
