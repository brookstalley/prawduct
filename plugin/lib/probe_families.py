...
def register_all() -> None:
    ...
    from .dependency_policy_probes import register as register_dependency_policy
    ...
    register_dependency_policy()  # upstream intake policy undeclared migration nudge
