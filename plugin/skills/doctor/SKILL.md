...
allowed-tools: Bash(prawduct-hook verify-operator-verification *), Bash(prawduct-hook audit-learnings *), Bash(prawduct-hook update-gitignore), Bash(prawduct-hook coverage-status *), Bash(prawduct-hook coverage-scaffold *), Read, Glob, Edit, Write
---
