...
- **Forward notes go in `.prawduct/.handoff-notes.md`** — the one session file you own, written
  at chunk close. `.session-handoff.md` is the machine's, regenerated at every `/clear`.
