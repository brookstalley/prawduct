...
These three are companions in the same `${CLAUDE_SKILL_DIR}/` directory; when the protocol refers to a sibling by bare name (e.g. `review-cycle.md`), read it from there.
