...
| Requirements clarity | discovery.md: Discovery Recurs + Feature-Level Discovery | build-plan.md: Requirements Confidence section | building.md: Before You Build; CLAUDE.md / session digest: Before Building runtime trigger | Goal 2 (acceptance criteria as observable behavior + Requirements Confidence field present) | v1.3.15 — full pipeline coverage anchored on Principle 6 (Requirements Precede Code) |
