...
**The instruction was right in every round but one.** Four of the five defects were the sentence explaining why; the exception (item 4) is worth keeping in view, because it is the same disease in the imperative mood — two nouns for one object, resolving toward data loss.

*(That absolute — "right every time" — was itself flagged as an over-claim by the review of this very entry: it enumerated four of five rounds and stated a universal the fifth contradicts. A claim stronger than the point requires, inside the rule against claims stronger than the point requires.)*
