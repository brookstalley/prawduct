...
## When you change a MECHANISM, cascade-search the CLAIM, not just the code — grepping the tokens you edited finds every site that RUNS the old procedure and none of the prose that DESCRIBES it. Enumerate the claims FIRST, **plural**: a change usually falsifies more than one, and cascading only the one your plan named leaves the others' carriers standing. Tell: you can state the claim you searched for in the singular — [learnings-detail.md]
