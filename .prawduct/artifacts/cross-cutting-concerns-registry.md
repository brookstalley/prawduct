...
<!-- sourced: agents/critic/SKILL.md, agents/review-lenses/SKILL.md, skills/domain-analyzer/SKILL.md, agents/artifact-generator/SKILL.md, skills/builder/SKILL.md, skills/orchestrator/onboarding.md, 2026-02-21 -->
...
| **Observability** | Complete | Dimension 7 (Operational Lifecycle) with observability sub-questions; Dimension 5 asks how you would know something failed | observability-strategy.md (universal); monitoring-alerting-spec.md (runs_unattended amplification); operational-spec.md Monitoring section | Builder implements logging infrastructure in scaffold (chunk 1), instruments key operations per observability-strategy each chunk | Check 1 observability compliance (flows instrumented, log levels, health check); Check 5 observability coherence (strategy ↔ monitoring ↔ preferences); Check 6 requires observation paths | Skeptic Lens evaluates debuggability for all products; Architecture Lens evaluates observability architecture connectedness and cost proportionality |
