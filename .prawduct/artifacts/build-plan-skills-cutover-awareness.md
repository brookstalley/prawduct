...
- [x] Chunk 04: Name-and-prose coherence sweep — built 2026-07-19, commit 2a0b1cf. The two deferred
      ...
      changeset (the split as corrected by cumulative finding R-10; `observability-strategy.md`'s
      Retroactivity line is authoritative), and the sweep heuristic recorded as non-exhaustive (id
      prefixes are open-ended).
