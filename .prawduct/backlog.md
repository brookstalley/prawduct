...
- **[GOV-4H7T]** Plugin ships `source: ./` with no packaging boundary — every repo-local file reaches consumer caches
  `effort: M · impact: M · area: governance/plugin-runtime · kind: feature · source: user · added: 2026-07-21 · reviewed: 2026-07-21 · status: open · stage: ready · related: GOV-6J3P, REL-5W2J · refs: .claude-plugin/marketplace.json:13 (`"source": "./"`), docs/release-process.md, docs/principles.md (Principle 10 — Clean Deployment)`
