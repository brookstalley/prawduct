...
- **[REL-7D4X]** Release runbook prescribes a positional change-log sweep, which drops entries that merged below the boundary
  `effort: S · impact: M · area: docs · kind: fix · source: user · added: 2026-07-21 · reviewed: 2026-07-27 · status: open · stage: ready · related: REL-2N8K, REL-5W2J, REL-9F2T, REL-8P6M · refs: .prawduct/runbooks/cut-and-publish-a-plugin-release.md (Phase 1 steps 2–3; `last_verified: null`), .prawduct/artifacts/release-plan-v3.1.1-hotfix.md, .prawduct/change-log.md, docs/release-process.md`
