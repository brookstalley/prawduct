...
- **[BKL-3W6K]** /prawduct:backlog skill is markdown-only — repoint it onto the GitHub-Issues adapter when backlog_service_repo is set
  `effort: M · impact: M · area: backlog-service · source: user · added: 2026-07-19 · reviewed: 2026-07-19 · status: open · stage: ready · related: BKL-6M4T, BKL-8P2R, BKL-5D2C · refs: .prawduct/artifacts/build-plan-backlog-skill-repoint.md`
