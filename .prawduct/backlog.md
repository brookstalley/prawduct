...
- **[REL-3K9P]** The pruned-promotion runbook is unverified and nothing can trigger its verification — its named verifier (v3.2.0's run) takes the whole-develop path and never opens it
