...
- **[REL-8P6M]** The release runbook has no pruned-release path — Phase 2 assumes `main`'s tree == `develop`'s tree, which is false for the promotion shape prawduct has now used twice
